...
public class Enemy {
    ...
    public void render(GL gl, TextureManager tm) {
        ...
        int animDirection = 0;
        if (direction >= 6 || direction <= 2) animDirection = 0; 
        else if (direction == 3 || direction == 5) animDirection = 1; 
        else if (direction == 4) animDirection = 2; 
